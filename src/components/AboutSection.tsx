...
const stats = [
  { number: "70+", label: "Проектов сдано" },
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            PixelForge — команда разработчиков и дизайнеров, которая превращает идеи в цифровые продукты. Мы не просто делаем красивые сайты — мы строим инструменты для роста бизнеса.
          </p>
        </div>
